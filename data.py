...
def load_rgi():
    fp = r"~/src/USGS/glacier_data/rgi60/01_rgi60_Alaska" 
    rgi = gpd.read_file(fp)
    
    # load AK RGI hypsometry
    fp = r"~/src/USGS/glacier_data/rgi60/01_rgi60_Alaska/01_rgi60_Alaska_hypso.csv"
    ...
    rgi = rgi.merge(rgi_hyp.loc[:, ['RGIId', 'Zela', 'abl_area', 'accu_area']], on='RGIId', how='left')
...
def load_mb():
    ...
    fp = r"~/src/USGS/glacier_data/DOI-WGMS-FoG-2020-08/WGMS-FoG-2020-08-A-GLACIER.csv"
    wgms = pd.read_csv(fp, encoding='iso-8859-1')
    wgms = wgms.loc[wgms['GLACIER_REGION_CODE'] == 'ALA', :]
    
    fp = r"~/src/USGS/glacier_data/DOI-WGMS-FoG-2020-08/WGMS-FoG-2020-08-AA-GLACIER_ID_LUT.csv"
    ...
    fp = r"~/src/USGS/glacier_data/DOI-WGMS-FoG-2020-08/WGMS-FoG-2020-08-EEE-MASS-BALANCE-POINT.csv"
    ...
    fp = r"~/src/USGS/glacier-diseq/data/from_joanna/JIF_point_mb_db.xlsx"
    ...
    fp = r"~/src/USGS/glacier-diseq/data/from_joanna/KAH_20102011_stakedata_databaseformat_JY.xlsx"
    ...
    fp = r"~/src/USGS/glacier-diseq/data/from_joanna/Index_site_KAH.xlsx"
    ...
    p = Path(r'~/src/USGS/glacier-diseq/data/USGS/eklutnaGlacierSurfaceMassBalance_2008_2015/eklutnaGlacierSurfaceMassBalance_2008_2015_sass.csv')
    ...
    p = Path(r'/Users/drotto/src/USGS/glacier-diseq/data/harding/KEFJ_Basic_Annual_MassBalance_Summary.xlsx')
...
fp = Path("/Users/drotto/src/USGS/glacier-diseq/data/gwi.csv")
gwi = pd.read_csv(fp, skiprows=5, header=0)[1:]
gwi = gwi.dropna(how='all', axis=1)
gwi['year'] = gwi['Date'] // 1